...
class Board:
    ...
    def run(self, max_instructions=10000, stop_at=None) -> int:
        ...
        for _ in range(max_instructions):
            ...
            if new_pc == pc and pc == previous_pc:
                break                     # spinning on B . -- firmware finished
            previous_pc = pc
        return executed
    ...
    def pending_irq(self):
        ...
        return [n for n, d in self.devices.items() if d.irq_pending]

    def service_interrupts(self) -> bool:
        """
        Deliver a physical IRQ to the CPU if any device is asserting and
